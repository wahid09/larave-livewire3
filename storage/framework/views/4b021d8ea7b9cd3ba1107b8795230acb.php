                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <!-- __BLOCK__ --><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'user-mgt-create')): ?>
                            <a wire:navigate href="<?php echo e(route('app.user.create')); ?>" class="btn btn-primary float-right"><i class="fa fa-plus-circle mr-1"></i> Add New</a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.sort-by','data' => ['wire:click' => 'sortBy(\'username\')','sortColumnName' => $sortColumnName,'sortDirection' => $sortDirection]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'sortBy(\'username\')','sortColumnName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sortColumnName),'sortDirection' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sortDirection)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <!-- __BLOCK__ --><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($users->firstItem() + $index); ?></td>
                                        <td><?php echo e($item->username); ?></td>
                                        <td><?php echo e($item->full_name); ?></td>
                                        <td>
                                            <!-- __BLOCK__ --><?php if($item->status == true): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\larave-livewire3\resources\views/livewire/user-mgt/user-list.blade.php ENDPATH**/ ?>